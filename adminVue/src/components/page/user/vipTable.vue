    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="fee" label="费用" width="150" >
                </el-table-column>
                <el-table-column prop="isComtent" label="评论审核" width="150" >
                </el-table-column>
                <el-table-column prop="isBase" label="默认权限" width="150" >
                </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="40%">
            <el-form ref="form" :model="form" label-width="100px">
                ...
                <el-form-item label="评论审核">
                    <el-input v-model="form.isComtent"></el-input>
                </el-form-item>
                <el-form-item label="默认权限">
                    <el-input v-model="form.isBase"></el-input>
                </el-form-item>
